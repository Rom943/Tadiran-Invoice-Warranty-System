 ...
 *         description: Not authorized
 */
router.get('/installers', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, adminController.getInstallerUsers);
/**
 * @swagger
 ...
 */
router.get('/installers/:installerId/warranties', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, adminController.getWarrantiesByInstaller);
/**
 * @swagger
 * /api/admin/admins:
 *   get:
 ...
 *         description: Not authorized
 */
router.get('/admins', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, adminController.getAdmins);
