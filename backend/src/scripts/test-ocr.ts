import { extractTextWithFallback, extractDatesFromText, validateWarrantyByOCR } from '../services/ocr.service';
...
async function testOCR() {
  ...
  try {
    ...
    const validation = await validateWarrantyByOCR(imagePath, installationDate);
